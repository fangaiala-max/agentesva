...
- [`DESIGN.md`](./DESIGN.md) — **AgentesVA product-brand** design system (fintech AI-visibility+accuracy SaaS; green/amber/red, Geist, dark-hero data-SaaS). Replaced the old "Editorial cálido" consulting brand 2026-06-05. Always read it before any UI work.
